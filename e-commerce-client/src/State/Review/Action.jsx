...
export const createReview = (resData) => async (dispatch) => {
  ...
  try {
    ...
    console.log("create review ", response.dat);
  } catch (error) {
...
export const getAllReviews = (productId) => async (dispatch) => {
  try {
    ...
    dispatch({ try: GET_ALL_REVIEWS_SUCCESS, payload: response.data });
...
export const createRating = (resData) => async (dispatch) => {
  try {
    ...
    dispatch({ try: CREATE_RATING_FAILURE, payload: error.message });
  }
};
